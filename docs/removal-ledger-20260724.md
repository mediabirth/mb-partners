...
| # | 対象 | 内容 | リード推奨 |
|---|---|---|---|
| R1 | 米井2口: ZZ3493(yoneikaito@)・ZZ8882(yonekai.00@)＋飯田deals2件（created_by=629e58cb） | 実スタッフのテストパートナー | **撤去**（米井は運営。必要になれば実招待し直す） |
| R2 | 日本ハウジング deal（MBHOUSE・paid） | 直営テスト起票 | **撤去**（MBHOUSE構造自体は残置） |
| R3 | ZZ6392 高 明（weltall.project@gmail.com） | 高さんの試用アカウント | **撤去**（実招待をクリーンにやり直す＝千秋楽の作法） |
...
| 案B=案A+R1+R2採用 | `f0cda850919327978126ece73d303434`（残=勝彦3件のみ） | 同上 | 同上 | 同上 |
