...
- **🎌開業儀式の突合（実データ）**: ZZ4172=高明さん（サプライヤー・omnis-founding-v1・法人・8/5 23:53）／ZZ8240=若菜優哉さん（リファラル・上位=高さん系統・8/6 02:06）＝**千秋楽成立・系統リンク正常**。card_events 8/5 11:16=ZZ4820（勝彦の自己テスト昇格）。⏳残課題: 高さんは修正デプロイ前登録のため **company_name=null**（正式社名の一言で埋める）。
