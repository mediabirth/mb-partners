...
const SECTIONS: { h: string; b: string }[] = [
  ...
  { h: '委託費の確定と支払', b: '委託費は案件ごとに事前提示され、納品・検収の完了をもって確定します。承認済の経費を加えた金額を、MB Partners が確定した時点で「委託費」に反映し、所定の振込日にお支払いします。' },
  { h: '成果物と権利', b: '納品物の取り扱い・著作権の帰属は、各案件で合意した条件に従います。再利用・公開の可否は事前にご確認ください。' },
  { h: '経費の精算', b: '案件に必要な経費は、領収書（任意）を添えて申請してください。MB Partners の承認後、委託費とあわせてお支払いします。' },
  { h: '守秘義務', b: '案件を通じて知り得たお客さま・MB Partners の情報は、許可なく第三者に開示しないでください。' },
]
const FAQ: { q: string; a: string }[] = [
  { q: '委託費はいつ振り込まれますか？', a: 'MB Partners が委託費を確定した月の締め後、所定の振込日にお支払いします。状況は「委託費」タブで確認できます。' },
  { q: '経費はどこから申請しますか？', a: '案件詳細の「お金」タブ →「経費を申請」から、種別・金額・領収書（任意）を添えて申請できます。' },
  { q: '日程はどう調整しますか？', a: '「予定」タブで MB Partners から届いた候補日を選んで確定できます。確定後は予定として表示されます。' },
]
