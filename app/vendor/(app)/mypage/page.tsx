...
export default async function VendorMypage() {
  ...
  return (
    <div className="page-anim" style={{ paddingTop: 22 }}>
      <div style={{ padding: '0 24px 6px', fontSize: '1rem', fontWeight: 500, letterSpacing: '-.01em' }}>マイページ</div>
      ...
      <ProfileHeader
        ...
        badges={<>
          ...
          {d.display_code && <span style={{ fontSize: '.56rem', fontWeight: 500, color: 'var(--muted2)', border: '0.5px solid var(--line)', borderRadius: 20, padding: '2px 10px', fontFamily: 'Inter' }}>{d.display_code}</span>}
        </>}
      />
