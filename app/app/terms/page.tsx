...
const FAQS = [
  ...
  {
    tag: 'FAQ', title: '報酬はメニューによって違いますか？',
    body: 'はい。紹介するメニューごとに報酬が決まっています（固定額または粗利（税抜）の料率）。メニュー選択時の報酬表示と、担当いただく内容（協力タスク）をご確認ください。つなぐだけのメニューは、あとは当社が対応します。',
  },
  {
